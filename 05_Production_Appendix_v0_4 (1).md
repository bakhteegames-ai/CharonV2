# Production Appendix — Charon Canon v0.4
...
## 6. Missing Runtime Folders Policy
Если в архиве ещё нет:
- `/public/models`
- `/public/audio`
- `/public/textures`
- `/public/ui`

это не значит, что их можно игнорировать.  
Это значит, что следующий asset drop должен их создать.
...
- latest docs pack
- manifests for all real assets already prepared
